...
public class Flight
{
  ...
  public Flight(String aSource, String aDestination, Date aFlightdate, String aAirline, String aNumber)
  {
    // line 81 "../../../../../LTS.ump"
  ...
  public String toString()
  {
    return super.toString() + "["+
            ...
            "  " + "flightdate" + "=" + (getFlightdate() != null ? !getFlightdate().equals(this)  ? getFlightdate().toString().replaceAll("  ","    ") : "this" : "null");
  }
}