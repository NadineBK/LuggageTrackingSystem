...
public class Tag
{
  ...
  public Tag(float aWeightForLuggage, float aWidthForLuggage, float aHeightForLuggage, float aLengthForLuggage, boolean aPriorityForLuggage, boolean aFragileForLuggage, boolean aCheckedInForLuggage, String aLocationForLuggage, Passenger aPassengerForLuggage)
  {
    luggageID = nextLuggageID++;
    luggage = new Luggage(aWeightForLuggage, aWidthForLuggage, aHeightForLuggage, aLengthForLuggage, aPriorityForLuggage, aFragileForLuggage, aCheckedInForLuggage, aLocationForLuggage, aPassengerForLuggage, this);
    flights = new ArrayList<Flight>();
  }
