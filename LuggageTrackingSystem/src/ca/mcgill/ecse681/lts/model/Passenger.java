...
public class Passenger
{
  ...
  public Transaction addTransaction(float aAmount, boolean aPaid, Date aTransactiondate, CreditCard aCreditCard)
  {
    return new Transaction(aAmount, aPaid, aTransactiondate, this, aCreditCard);
  }
  ...
  public Luggage addLuggage(float aWeight, float aWidth, float aHeight, float aLength, boolean aPriority, boolean aFragile, boolean aCheckedIn, String aLocation, Tag aTag)
  {
    ...
    {
      return new Luggage(aWeight, aWidth, aHeight, aLength, aPriority, aFragile, aCheckedIn, aLocation, this, aTag);
    }
  }
